import torch
import numpy as np
from gaustar_utils.general_utils import get_expon_lr_func
...
class SuGaROptimizer():
    ...
    def __init__(
        ...
        if model.binded_to_surface_mesh and model.learn_surface_mesh_delta:
            l = l + [{'params': [model._delta_t], 'lr': opt.position_lr_init * spatial_lr_scale, "name": "delta_t"}]
            l = l + [{'params': [model._delta_r], 'lr': opt.rotation_lr, "name": "delta_r"}]
